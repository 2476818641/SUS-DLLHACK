...
private:
    ...
    void addVerifiedCandidate(const ValidationJob &job, bool proxyLoaded, const QStringList &called, const QString &sourcePath);
    ...
    QCheckBox *m_dllMainTrigger = nullptr;
    QCheckBox *m_apcInject = nullptr;
    QCheckBox *m_dbgLog = nullptr;
